...
int main()
{
    ...
    Shader asteroidShader("src/shaders/instancing.vert", "src/shaders/instancing.frag");
    Shader planetShader("src/shaders/default.vert", "src/shaders/default.frag");
	...
	unsigned int transparentTexture = loadTexture("src/textures/transparentWindow.png");
    ...
    while(!glfwWindowShouldClose(window.GetGLFWwindow()))
    {
        ...
        glm::mat4 projection = glm::perspective(glm::radians(45.0f), (float)window.GetWidth() / (float)window.GetHeight(), 0.1f, 1000.0f);
